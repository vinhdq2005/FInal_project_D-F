...
function renderData(data) {
  ...
  for (let i = 0; i < data.length; i++) {
      document.querySelector(`#viewmoreIcon${i}`).addEventListener("click",()=>{
          console.log(data[i]);
  ...
  <div class="viewmore-container">
    ...
    <div class="viewmore-right">
      ...
      <form action="" class="viewmore-form">
        <div class="quantity" id="quantity-product">
          <input type="number" min="0" value="1">
        </div>
        <input type="submit" class="submit-btn addtocartbtn" value="Add to cart" />
      </form>
